...
func FromEnv() Config {
	return Config{
		...
		StaticDir:                   env("APPLIANCE_UI_STATIC_DIR", "bin/dist"),
		ApplicationLogPath:          env("APPLIANCE_UI_APPLICATION_LOG_PATH", "/data/zon/logs/ui/application.log"),
		ControlPlaneBaseURL:         strings.TrimRight(env("APPLIANCE_CONTROL_PLANE_BASE_URL", "http://controlplane:8080"), "/"),
		ControlPlaneInternalBaseURL: strings.TrimRight(env("APPLIANCE_CONTROL_PLANE_INTERNAL_BASE_URL", "http://controlplane-internal:8081"), "/"),

...
//
//	go build -ldflags "-X appliance-code/server/backend/internal/version.Version=... -X appliance-code/server/backend/internal/version.Commit=... -X appliance-code/server/backend/internal/version.BuildTime=..."
var (
	Version   = "0.0.0-dev"
	Commit    = "unknown"
	BuildTime = "unknown"
